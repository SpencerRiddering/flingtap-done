...
//                && (mCurrentView.isRootNamespace())
    ...
    public class TabSpec {
        ...
        // HACK: Since Proguard has a problem with private inner class constructors, I've changed this constructor to be public. See: http://sourceforge.net/forum/forum.php?thread_id=3342716&forum_id=182456
...
//            if (getContext().getApplicationInfo().targetSdkVersion <= 4) { //Build.VERSION_CODES.DONUT
//            if ( Integer.parseInt(Build.VERSION.SDK) <= 4) {                // Donut apps get old color scheme
                // Donut apps get old color scheme
//                tabIndicator.setBackgroundResource(R.drawable.tab_indicator_v4);
                tv.setTextColor(getContext().getResources().getColorStateList(R.color.tab_indicator_text_v4));
//            }
